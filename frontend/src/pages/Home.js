          ...
          <div ref={servicesGridRef} className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            {servicesList.map((service, index) => (
              <Link key={index} to="/services"
                className="stagger-item reveal group relative h-64 sm:h-80 md:h-96 overflow-hidden img-zoom corner-accent glow-hover active:scale-[0.98] transition-transform">
